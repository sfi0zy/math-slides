...
export default class Slide20 extends SlideParametric {
    constructor(canvas) {
        super(canvas);
        ...
        this.drawText('A1', 220, 450, 'left');
        this.drawText('A2', 220, 400, 'left');

        this.drawText('B1', 460, 250, 'left');
        this.drawText('B2', 460, 300, 'left');
    }
}
